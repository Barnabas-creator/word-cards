...
- fam：同一词族的派生词，最多 4 个，按常用度排序。必须是真实存在的英语词。没有派生词就给空数组。
  只放派生词（nation → national / nationality），不要放屈折形：过去式、-ing、复数、第三人称单数都不要
  （make → making、want → wanted 这种不算）。已经独立成词、意思变了的例外（find → finding 作「发现、结论」，thought 作名词）
- ex：一个英语例句，长度 8–20 个词，难度控制在 CEFR B2，必须包含该词或它的某个派生形
- exZh：例句的中文翻译，自然流畅
- conf：形近或义近的易混词，最多 3 个，必须是真实英语词，不能跟 fam 里的词重复。没有就给空数组
